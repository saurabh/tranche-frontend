...
import { required, number, roundNumber, isGreaterThan, isEqualTo, isLessThan, safeDivide, safeAdd, formatTime } from 'utils';
      ...
      <Form onSubmit={(e) => adjustStake(e, contractAddress, tokenAddress, durationIndex, migrate)}>
        ...
        <ApproveBtnWrapper migrate={migrate}>
          ...
          <StakeModalFormBtn
            ...
            migrate={migrate}
            migrateStep={migrate}
            disabled={!hasAllowance || isEqualTo(amount, 0) || isLessThan(amount, 0) || amount === '' || balanceCheck === 'InputStylingError'}

import { Key, Agree, DaiLogo, ETH as ETHicon, TrancheClaim, DaiClaim, EthClaim, AAVE, CompoundLogo, USDCCard, USDTCard, DAICARD, MaticTable, TrancheStake, 
  ETHCARD, Chainlink, WBTC, YearnIcon, FantomIcon, MIMIcon, YFIIcon, TAAVAX, TBAVAX, TBWETH, TAWETH, TABTC, TBBTC, TAVAX, TWETH, TBTC } from 'assets';
...
export const trancheIcons = {
  ...
  aavWAVAX: { protocolIcon: AAVE, assetIcon: TAVAX },
  bavWAVAX: { protocolIcon: AAVE, assetIcon: TAVAX },
  aavWETH: { protocolIcon: AAVE, assetIcon: TWETH },
  bavWETH: { protocolIcon: AAVE, assetIcon: TWETH },
  aavWBTC: { protocolIcon: AAVE, assetIcon: TBTC },
  bavWBTC: { protocolIcon: AAVE, assetIcon: TBTC },
  aavDAI: { protocolIcon: AAVE, assetIcon: DAICARD },
  bavDAI: { protocolIcon: AAVE, assetIcon: DAICARD },
  aavUSDT: { protocolIcon: AAVE, assetIcon: USDTCard },
  bavUSDT: { protocolIcon: AAVE, assetIcon: USDTCard },
  aavUSDC: { protocolIcon: AAVE, assetIcon: USDCCard },
  bavUSDC: { protocolIcon: AAVE, assetIcon: USDCCard },
  aavAAVE: { protocolIcon: AAVE, assetIcon: AAVE },
  bavAAVE:{ protocolIcon: AAVE, assetIcon: AAVE },
};
